...
public class AnalyzerExampleTest {
    ...
    public void testEnglishAnalysis() throws IOException {
        ...
        printer.printTerms(new EnglishAnalyzer(Version.LUCENE_43), english);
    }
    ...
    public void testFrenchAnalysis() throws IOException {
        ...
        printer.printTerms(new FrenchAnalyzer(Version.LUCENE_43), french);
    }
    ...
    public void testJapaneseAnalysis() throws IOException {
        ...
        printer.printTerms(new JapaneseAnalyzer(Version.LUCENE_43), japanese);
    }
}